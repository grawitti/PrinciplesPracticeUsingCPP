...
int main()
{
    try
    {
		...
		gods = gods->insert(new Link{God{"Odin","Norse","flying horse","Goongner"}});
		gods = gods->insert(new Link{God{"Zeus","Greek","","Thunderbolt"}});
		gods = gods->insert(new Link{God{"Freia","Norse"}});
		gods = gods->insert(new Link{God{"Hera","Greek"}});
		gods = gods->insert(new Link{God{"Athena","Greek","","Sword"}});
		gods = gods->insert(new Link{God{"Mars","Greek"}});
		gods = gods->insert(new Link{God{"Rod","Sloviansky","","Rain"}});
		gods = gods->insert(new Link{God{"Svarog","Sloviansky","","Thunderbolt"}});
