...
int main() {
	...
	try {
		cout << "Реализация класса Roman_int для хранения римских цифр.\n";
	
		cout << "Введите целое число: ";
		int i = 0;
		cin >> i;

		Roman_int r{digConvert(i)};
		cout << "Вы ввели арабское целое число: " << i << " = римское: " << r << endl;

		cout << "Вы ввели римское число: " << r << " = арабское: " << romanToInt(srcArabVector(r.romain())) << endl;
			
		Roman_int r2;
		cout << "Введите римское число: ";
		cin.ignore();
		cin >> r2;
		cout << "Вы ввели римское число: " << r2 << endl;
