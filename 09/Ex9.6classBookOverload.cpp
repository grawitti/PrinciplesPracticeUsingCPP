/**
 Дата создания: 02.02.18
 Автор: Руслан
 Назначение: Реализация класса Book.
 Глава 9, упр. 6, стр. 388, Б. Страуструп "Программирование принципы и практика с использованием С++" (2 изд. 2016 г.)
 Пример:
 Changelog:
...
//Приветствие
void welcomeMessage () {
	cout << "Реализация класса Book 0.9.6.\n";
}
